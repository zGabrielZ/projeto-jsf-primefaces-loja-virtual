...
@Named
@RequestScoped
public class VerificarDataNascimento implements Validator{
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		if(dataNascimento != null) {
			if(dataNascimento.isAfter(dataAtual)) {
				descricaoErro = label + ": Não é possível cadastrar esta data de nascimento, pois a data não pode ser maior que a data atual !";
